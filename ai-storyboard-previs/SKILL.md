...
python scripts/review_draft.py prepare PROJECT.json G01 GROUP_REVIEW.json
# Fill observations and judgments in GROUP_REVIEW.json before checking.
python scripts/review_draft.py check PROJECT.json GROUP_REVIEW.json
